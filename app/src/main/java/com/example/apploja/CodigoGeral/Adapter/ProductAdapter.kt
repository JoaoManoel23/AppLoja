package com.example.apploja.CodigoGeral.Adapter
...
import com.example.apploja.convertToMoneyWithSymbol

class ProductAdapter(
    private val items: MutableList<Product>,
    private val gotToDetail: (item: Product) -> Unit
) :
